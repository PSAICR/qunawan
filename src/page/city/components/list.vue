<template>
    <div id="city-list">
      <!--城市列表模块-->
      <ul v-for="(city,index) in cityList" :key="index">
        
        <li class="style-letter" v-if="isLetter(city)">{{city}}</li>
        <li class="item-city" v-if="!isLetter(city)">{{city}}</li>
      </ul>
    </div>
</template>
...
export default {
  ...
  data(){
    return {
      cityList:[ "A","阿坝","阿拉善","阿里","安康","安庆","鞍山","安顺","安阳","澳门","B","北京","白银",  
